...
- Pinned all `docs` dependencies to Python 3.13 and above. This is the version the 
  docs are built with, so this ensures that the docs dependencies are kept up to date.
