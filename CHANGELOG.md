...
- Changed the error message that appears when attempting to add a subcommand group under
  a subcommand group. ([#2275](https://github.com/Pycord-Development/pycord/pull/2275))
