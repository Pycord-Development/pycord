    ...
    while True:
        await bot.change_presence(
            activity=discord.Activity(
                type=discord.ActivityType.watching, name=f"PyCord Docs"
            )
        )
        await asyncio.sleep(300)
        await bot.change_presence(
            activity=discord.Game(name=f"with {len(bot.users)} members")
        )
        await asyncio.sleep(300)
        await bot.change_presence(
            activity=discord.Activity(
                type=discord.ActivityType.watching, name="https://pycord.dev/"
            )
        )
        await asyncio.sleep(300)
