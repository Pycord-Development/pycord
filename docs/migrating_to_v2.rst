...
v2.0 introduced new discord features and 

Part of the redesign involves making application commands and components. These changes include a new :class:`Bot` instance, :class:`ui.View`, and a new :class:`ApplicationContext` class.
